...
.. function:: cbgetstate(d::MathProgCallbackData)
   ...
   *    ``MIPSol``: when we have found a new MIP incumbent (an integer-feasible solution). This is generally used for keeping track of the incumbent/intermediate solutions generated inside the branch-and-cut tree.
